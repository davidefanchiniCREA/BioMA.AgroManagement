...
{
    /// <summary>
    /// Data type to model vine winter pruning
    /// </summary>
    public partial class VineWinterPruning : IManagementTree
    {
            ...
            foreach(XmlNode child in node.ChildNodes)
            {
                switch (child.Attributes["name"].InnerText)
                {
                    ...
                    case ("TreeOperation"):
                        ...
                        break;
                    case ("NewCrownRadius"):
                        _newCrownRadius = double.Parse(child.Attributes["value"].InnerText);
                        break;
                }
            }
        }
        ...
        public void SaveXml(XmlTextWriter writer)
        {
            ...
            writer.WriteStartElement("parameter");
            writer.WriteAttributeString("name", "NewCrownRadius");
            writer.WriteAttributeString("value", _newCrownRadius.ToString());
            writer.WriteEndElement();
        }
        #endregion
        ...
        /// Crop name
        /// </summary>
        [ImpactMap("BioMA.AgroManagement.Impacts", "CRA.AgroManagement.Impacts.VineWinterPruning", "TreeNameMap")]
        ...
        /// Crop name
        /// </summary>
        [ImpactMap("BioMA.AgroManagement.Impacts", "CRA.AgroManagement.Impacts.VineWinterPruning", "TreeTypeMap")]
        [TypeConverter(typeof(DictionaryConverter))]
        ...
        private double _newCrownRadius;
        /// <summary>
        /// Ratio of crown kept after green pruning
        /// </summary>
        public double NewCrownRadius
        {
            get { return _newCrownRadius; }
            set { _newCrownRadius = value; }
        }
