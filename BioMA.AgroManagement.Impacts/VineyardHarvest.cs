...
namespace CRA.AgroManagement.Impacts
{
    ...
    /// </summary>
    public partial class VineyardHarvest : IManagementTree
    {
        ...
        /// Crop name
        /// </summary>
        [ImpactMap("BioMA.AgroManagement.Impacts", "CRA.AgroManagement.Impacts.VineyardHarvest", "TreeNameMap")]
        ...
        /// Crop name
        /// </summary>
        [ImpactMap("BioMA.AgroManagement.Impacts", "CRA.AgroManagement.Impacts.VineyardHarvest", "TreeTypeMap")]
        [TypeConverter(typeof(DictionaryConverter))]
            ...
            get
            {
                if (_treeTypeMap == null)
                {
                    _treeTypeMap = new ImpactMap
                        (VineyardHarvest.XML_MAP_FILENAME,
                         VineyardHarvest.XML_ELEMENT_NAME2);
                }
                return _treeTypeMap;
            }
        }
